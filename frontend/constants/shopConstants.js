...
export const SHOP_SEND_EMAIL_REQUEST = 'SHOP_SEND_EMAIL_REQUEST'
export const SHOP_SEND_EMAIL_SUCCESS = 'SHOP_SEND_EMAIL_SUCCESS'
export const SHOP_SEND_EMAIL_FAIL = 'SHOP_SEND_EMAIL_FAIL'
...
export const SHOP_UPDATE_FAIL_RESET = 'SHOP_UPDATE_FAIL_RESET'
